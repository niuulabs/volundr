...
const FULL_TOPOLOGY: Topology = {
  ...
  nodes: [
    ...
    { id: 'realm-bifrost',  typeId: 'realm',     label: 'bifröst-edge', parentId: null,                status: 'healthy' },
    // Clusters
    { id: 'cluster-vk',     typeId: 'cluster',   label: 'valaskjálf',   parentId: 'realm-asgard',      status: 'healthy' },
    { id: 'cluster-vh',     typeId: 'cluster',   label: 'valhalla',     parentId: 'realm-asgard',      status: 'healthy' },
    { id: 'cluster-gl',     typeId: 'cluster',   label: 'glitnir',      parentId: 'realm-alfheim',     status: 'healthy' },
    // Hosts
    { id: 'host-tanngrisnir', typeId: 'host',    label: 'tanngrisnir',  parentId: 'realm-asgard',      status: 'healthy' },
    { id: 'host-saga',      typeId: 'host',      label: 'saga',         parentId: 'realm-vanaheim',    status: 'healthy' },
    // Coordinators
    ...
    { id: 'volundr-0',      typeId: 'volundr',   label: 'völundr-0',    parentId: 'cluster-vh',        status: 'healthy' },
    // Agents
    { id: 'ravn-huginn',    typeId: 'ravn_long', label: 'huginn',       parentId: 'host-tanngrisnir',  status: 'healthy' },
    { id: 'ravn-muninn',    typeId: 'ravn_long', label: 'muninn',       parentId: 'host-tanngrisnir',  status: 'idle' },
    { id: 'skuld-0',        typeId: 'skuld',     label: 'skuld-0',      parentId: 'cluster-vk',        status: 'healthy' },
    { id: 'valk-brynhildr', typeId: 'valkyrie',  label: 'brynhildr',    parentId: 'cluster-vk',        status: 'healthy' },
    // Raid
    { id: 'raid-omega',     typeId: 'raid',      label: 'raid-omega',   parentId: 'cluster-vk',        status: 'observing' },
    { id: 'ravn-coord',     typeId: 'ravn_raid', label: 'coord-1',      parentId: 'raid-omega',        status: 'healthy' },
    { id: 'ravn-rev',       typeId: 'ravn_raid', label: 'reviewer-1',   parentId: 'raid-omega',        status: 'healthy' },
    // Services
    { id: 'svc-grafana',    typeId: 'service',   label: 'grafana',      parentId: 'cluster-gl',        status: 'healthy' },
    { id: 'svc-pg',         typeId: 'service',   label: 'postgresql',   parentId: 'cluster-vk',        status: 'healthy' },
    // Models
    { id: 'model-claude',   typeId: 'model',     label: 'claude-sonnet',parentId: 'realm-bifrost',     status: 'healthy' },
    { id: 'model-gpt4',     typeId: 'model',     label: 'gpt-4o',       parentId: 'realm-bifrost',     status: 'healthy' },
    { id: 'model-ollama',   typeId: 'model',     label: 'ollama',       parentId: 'cluster-vk',        status: 'healthy' },
    // Devices
    { id: 'printer-gungnir',typeId: 'printer',   label: 'gungnir',      parentId: 'realm-midgard',     status: 'healthy' },
    { id: 'vaettir-office', typeId: 'vaettir',   label: 'chatterbox/office', parentId: 'realm-midgard', status: 'healthy' },
    { id: 'beacon-office',  typeId: 'beacon',    label: 'espresense/office', parentId: 'realm-midgard', status: 'healthy' },
    // Sub-Mímirs
    { id: 'mimir-code',     typeId: 'mimir_sub', label: 'mímir/code',   parentId: 'mimir-0',           status: 'healthy' },
    { id: 'mimir-ops',      typeId: 'mimir_sub', label: 'mímir/ops',    parentId: 'mimir-0',           status: 'healthy' },
  ],
  edges: [
...
const MINIMAL_TOPOLOGY: Topology = {
  ...
  edges: [
    { id: 'e1', sourceId: 'tyr-0', targetId: 'mimir-0', kind: 'soft' },
  ],
};
  ...
  args: {
    topology: {
      ...
      nodes: [
        ...
        { id: 'cluster-vk', typeId: 'cluster',   label: 'cluster',  parentId: 'realm-a',      status: 'healthy' },
        ...
        { id: 'ravn-a',     typeId: 'ravn_long', label: 'huginn',   parentId: 'cluster-vk',   status: 'healthy' },
        { id: 'raid-0',     typeId: 'raid',      label: 'raid',     parentId: 'cluster-vk',   status: 'observing' },
        { id: 'ravn-raid-a',typeId: 'ravn_raid', label: 'coord',    parentId: 'raid-0',        status: 'healthy' },
      ],
      edges: [
