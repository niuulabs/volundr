...
const SEED_RAVENS: Ravn[] = [
  ...
  },
  {
    ...
    mcpServers: ['filesystem', 'sast'],
    gatewayChannels: [],
    eventSubscriptions: ['code.changed', 'security.completed'],
  },
  {
    ...
    eventSubscriptions: ['review.completed', 'test.requested', 'qa.completed'],
  },
  {
    ...
    eventSubscriptions: ['bug.reported', 'incident.opened', 'investigation.completed'],
  },
  {
    ...
    eventSubscriptions: ['health.check.requested', 'cron.hourly', 'health.completed'],
  },
];
...
const SEED_TRIGGERS: Trigger[] = [
  {
    ...
    lastFiredAt: '2026-04-15T08:00:00Z',
    fireCount: 336,
  },
  {
    ...
    enabled: true,
    createdAt: '2026-04-01T00:00:00Z',
    lastFiredAt: '2026-04-15T09:10:00Z',
    fireCount: 47,
  },
  {
    ...
    enabled: true,
    createdAt: '2026-04-01T00:00:00Z',
    lastFiredAt: '2026-04-15T08:55:00Z',
    fireCount: 31,
  },
  {
    ...
    lastFiredAt: '2026-04-12T14:30:00Z',
    fireCount: 3,
  },
  {
    ...
    lastFiredAt: '2026-04-14T22:10:00Z',
    fireCount: 8,
  },
];
