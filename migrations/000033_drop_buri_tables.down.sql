-- Restore Búri knowledge memory substrate tables (rollback of NIU-576 drop).
--
-- Recreates the schema from 000029_buri_knowledge_facts.up.sql so that
-- the migration tool can roll back cleanly.  Data is not restored.
