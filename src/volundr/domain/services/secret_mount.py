...
class SecretMountService:
    ...
    def generate_pod_annotations(
        ...
        annotations: dict[str, str] = {
            ...
            "vault.hashicorp.com/role": (f"volundr-session-{session_id}"),
            "vault.hashicorp.com/agent-pre-populate-only": ("false" if has_renewal else "true"),
        }
        return annotations
