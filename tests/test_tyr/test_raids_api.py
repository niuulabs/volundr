...
from tyr.api.raids import (
    CONFIDENCE_DELTA_APPROVED,
    CONFIDENCE_DELTA_REJECTED,
    CONFIDENCE_DELTA_RETRY,
    create_raids_router,
    resolve_git,
    resolve_raid_repo,
    resolve_tracker,
...
class TestApproveRaid:
    def test_approve_success(
        ...
        assert events[0].delta == CONFIDENCE_DELTA_APPROVED
...
class TestRejectRaid:
    def test_reject_success(self, client: TestClient, raid_repo: MockRaidRepository):
        ...
        assert events[0].delta == CONFIDENCE_DELTA_REJECTED
...
class TestRetryRaid:
    def test_retry_success(self, client: TestClient, raid_repo: MockRaidRepository):
        ...
        assert events[0].delta == CONFIDENCE_DELTA_RETRY
    ...
    def test_retry_from_failed_state(self, client: TestClient, raid_repo: MockRaidRepository):
