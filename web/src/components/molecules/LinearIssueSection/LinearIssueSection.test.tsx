...
describe('LinearIssueSection', () => {
  ...
  it('renders issue identifier as a link', () => {
    render(<LinearIssueSection issue={issue} onStatusChange={mockOnStatusChange} />);
  ...
  it('does not render assignee when not present', () => {
    ...
    render(<LinearIssueSection issue={noAssignee} onStatusChange={mockOnStatusChange} />);
  ...
  it('does not render priority when 0', () => {
    ...
    render(<LinearIssueSection issue={noPriority} onStatusChange={mockOnStatusChange} />);
